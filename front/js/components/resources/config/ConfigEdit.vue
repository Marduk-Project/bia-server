<template>
  <div v-if="entity" class="container">
    ...
    <h1>{{ crud_title }}</h1>
    <p class="text-danger">
      <strong>Atenção!</strong> Configurações erradas podem comprometer o funcionamento do sistema.
      <br>Apenas administradores podem alterar este cadastro.
    </p>
    <form action @submit.prevent novalidate>
      ...
      <div class="form-row">
        <div class="form-group col-lg-4">
          ...
          <input class="form-control" type="color" v-model="entity.alert.color_lh_low">
        </div>
        <!-- futuro -->
        <!-- <div class="form-group col-lg-4">
        ...
        <div class="form-group col-lg-4">
          ...
          <input class="form-control" type="color" v-model="entity.alert.color_lh_high">
        </div>
      </div>
      <br>
      <div class="form-row">
        <app-crud-buttons @onSave="crud_onSaveAction" :delete-show="false"></app-crud-buttons>
      </div>
    </form>
  </div>
</template>
