...
const { model: UserModel, jsonSerializer: userJsonSerializer } = require('./gl_user');
...
const scopes = {
  ...
  admin: {
    maps: {
      ...
      personReference: async (value, scopeName) => await personJsonSerializer(value, scopeName),
      user: async (value, scopeName) => await userJsonSerializer(value, scopeName),
    }
  }
}
