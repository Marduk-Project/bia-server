...
const { model: FieldModel, jsonSerializer: fieldJsonSerializer, DESTINATION_GL_PERSON } = require('./gl_field');
const { model: FieldItemModel, jsonSerializer: fieldItemJsonSerializer } = require('./gl_field_item');
const { model: PersonModel, jsonSerializer: personJsonSerializer } = require('./gl_person');
...
const scopes = {
  ...
  admin: {
    ...
    fieldItem: async (value, scopeName) => await fieldItemJsonSerializer(value, scopeName),
    person: async (value, scopeName) => await personJsonSerializer(value, scopeName),
  }
}
